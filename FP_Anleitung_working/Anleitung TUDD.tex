\documentclass[nochapterpage,bigchapter,article,linedtoc,colorback,accentcolor=tud1b,11pt]{tudreport}
\usepackage{ngerman}
...
%\usepackage[ngerman,colorlinks=false,pdfborder={1 0 0}]{hyperref}
...
\settitlepicture{Bilder/g.jpg}
% \printpicturesize

\title{Kühlen und Fangen von Rubidiumatomen in einer magneto-optischen Falle}
\subtitle{Fortgeschrittenen Praktikum}

\usepackage{cite}

\usepackage[bookmarksopen=true,pdfpagelabels=true,colorlinks=true]{hyperref}
...
\maketitle
\centering
\includegraphics[width=464px]{Bilder/RA.jpg}
\justify
\pdfbookmark[1]{Inhaltsverzeichnis}{toc} % F?gt im pdf-Men? einen Eintrag f?r's Inhaltsverzeichnis hinzu
...
\begin{tabular}{lll}
	...
	& ~ & ~\\
	\includegraphics[width=8px]{Bilder/Kaestchen/SL.jpg} & Spiegel der Laserstabilisierung u. ~ \includegraphics[width=8px]{Bilder/Kaestchen/SM.jpg} ~ der MOT& \autoref{fig:SL}\\
	\includegraphics[width=8px]{Bilder/Kaestchen/ST.jpg} & Strahlteiler ~~ u. ~ \includegraphics[width=8px]{Bilder/Kaestchen/RD.jpg} ~ Rubidiumdampfzelle & \autoref{fig:SW}\\
	\includegraphics[width=8px]{Bilder/Kaestchen/PD.jpg} & Photodioden \medspace u. ~ \includegraphics[width=8px]{Bilder/Kaestchen/UK.jpg} ~ USB-Kamera ~ & \autoref{fig:PD}\\
	\includegraphics[width=8px]{Bilder/Kaestchen/LH.jpg} & $\lambda/2$-Platten ~ u. ~   \includegraphics[width=8px]{Bilder/Kaestchen/LV.jpg} ~ $\lambda/4$-Platten & \autoref{fig:LH}\\
		...
		\fbox{\parbox[c]{17,2cm}{
			...
			\fbox{\parbox[c]{17,2cm}{
				...
				\fbox{\parbox[c]{17,2cm}{
					...
					\newpage
					\nocite{SL, CT, NL} 
					\bibliography{Literatur} % Name der Literaturdatei (ohne .bib-Endung)
					\bibliographystyle{unsrt} % Stil der Quellenangabe. Üblich: alpha, unsrt, plain
					\addcontentsline{toc}{section}{Literaturverzeichnis} % Fügt Eintrag (als section) im Inhaltsverzeichnis hinzu
