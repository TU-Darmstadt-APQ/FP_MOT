...
\item Niveaustruktur \isotope[85]{Rb}
\begin{itemize}
\item Kernspin $I=\frac{5}{2}$ 
\item Grundzustand: $5^2\rm{S}_{\frac{1}{2}}$ ($n=5$, $S=\frac{1}{2}$, $L=0$ $\Rightarrow$ $J=\frac{1}{2}$) 
\item angeregter Zustand: $L=1 \Rightarrow$ $5^2\rm{P}_{\frac{1}{2}}$ ($J=\frac{1}{2}$; D1-Linie) oder $5^2\rm{P}_{\frac{3}{2}}$ ($J=\frac{3}{2}$; D2-Linie) 
\item Hyperfeinstrukturaufspaltung wegen Entartung des Gesamtdrehimpuls: $|J-I|<F<J+I$ 
\item Natürliche Linienbreite  $\Gamma=2\pi\cdot\unit[6]{MHz} =\frac{1}{\tau}$ mit $\tau=\unit[26]{ns}$ Lebensdauer
\end{itemize}
\end{itemize}
...
\item Verstimmung: $\Delta_{\text{OM}} = \Delta \mp k \cdot v_x \pm \frac{g_{F'} m_{F'} \mu_B B_0}{\hbar} \cdot x$
...
\begin{figure}[htb!]
	\centering
	\includegraphics[width = 0.95\textwidth]{spectroscopy.png}
	\caption{Transmission der dopplerfreien Sättigungsspektroskopie von Rubidium inklusive aller vier Linien.}
\end{figure}
