...
\begin{tabular}{lll}
	...
	& ~ & ~\\
	\includegraphics[width=8px]{graphics/Kaestchen/SL.jpg} & Spiegel der Laserstabilisierung u. ~ \includegraphics[width=8px]{graphics/Kaestchen/SM.jpg} ~ der MOT& \autoref{fig:SL}\\
	\includegraphics[width=8px]{graphics/Kaestchen/ST.jpg} & Strahlteiler ~~ u. ~ \includegraphics[width=8px]{graphics/Kaestchen/RD.jpg} ~ Rubidiumdampfzelle & \autoref{fig:SW}\\
	\includegraphics[width=8px]{graphics/Kaestchen/PD.jpg} & Photodioden \medspace u. ~ \includegraphics[width=8px]{graphics/Kaestchen/UK.jpg} ~ USB-Kamera ~ & \autoref{fig:PD}\\
	\includegraphics[width=8px]{graphics/Kaestchen/LH.jpg} & $\lambda/2$-Platten ~ u. ~   \includegraphics[width=8px]{graphics/Kaestchen/LV.jpg} ~ $\lambda/4$-Platten & \autoref{fig:LH}\\
	\includegraphics[width=8px]{graphics/Kaestchen/LN.jpg} & Linsen & \autoref{fig:LI}\\
\end{tabular}
...
\begin{tabular}{lll}
	...
	& ~ & ~\\
	\includegraphics[width=8px]{graphics/Kaestchen/RL.jpg} & Spektroskopie Rückpumplaser & \autoref{fig:SPM}\\
	\includegraphics[width=8px]{graphics/Kaestchen/SLS.jpg} & Spektroskopie Kühllaser & \autoref{fig:SPS}\\
	\includegraphics[width=8px]{graphics/Kaestchen/OL.jpg} & Offsetlock für den Kühllasers ~~~~~~~~~~~~~~~~~~~~~~~~~ & \autoref{fig:OFL}\\
	\includegraphics[width=8px]{graphics/Kaestchen/RL.jpg} & zur MOT Rückpumplaser & \autoref{fig:MM}\\
	\includegraphics[width=8px]{graphics/Kaestchen/SLS.jpg} & zur MOT Kühllaser & \autoref{fig:SZM}\\
	\includegraphics[width=8px]{graphics/Kaestchen/ML.jpg} & MOT & \autoref{fig:MOTSTG}\\
	\includegraphics[width=8px]{graphics/Kaestchen/AS.jpg} & alle Strahlengänge & \autoref{fig:STGK}\\
	& ~ & ~\\
	\includegraphics[width=8px]{graphics/Kaestchen/AM.jpg} & alle Strahlengänge und alle Elemente  & \autoref{fig:AEGB}\\
	& (vgl. Abbildung 3) &
\end{tabular}
