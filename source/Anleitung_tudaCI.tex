...
\begin{tabular}{lll}
	...
	& ~ & ~\\
	\includegraphics[width=8px]{graphics/Kaestchen/SL.jpg} & Spiegel der Laserstabilisierung u. ~ \includegraphics[width=8px]{graphics/Kaestchen/SM.jpg} ~ der MOT & \ref{fig:SL}\\
	\includegraphics[width=8px]{graphics/Kaestchen/ST.jpg} & Strahlteiler ~~ u. ~ \includegraphics[width=8px]{graphics/Kaestchen/RD.jpg} ~ Rubidiumdampfzelle & \ref{fig:SW}\\
	\includegraphics[width=8px]{graphics/Kaestchen/PD.jpg} & Photodioden \medspace u. ~ \includegraphics[width=8px]{graphics/Kaestchen/UK.jpg} ~ USB-Kamera ~ & \ref{fig:PD}\\
	\includegraphics[width=8px]{graphics/Kaestchen/LH.jpg} & $\lambda/2$-Platten ~ u. ~   \includegraphics[width=8px]{graphics/Kaestchen/LV.jpg} ~ $\lambda/4$-Platten & \ref{fig:LH}\\
	\includegraphics[width=8px]{graphics/Kaestchen/LN.jpg} & Linsen & \ref{fig:LI}\\
\end{tabular}
...
\vspace{7pt}
		...
		\fbox{\parbox[c]{0.985\textwidth}{
				\begin{frage}\label{f4-1}
					Zu welchem Zweck werden die PST verwendet und warum kommen sie stets in Kombination mit einer $\nicefrac{\lambda}{2}$-Platte vor?  
				\end{frage}
			}}\\
			...
			\fbox{\parbox[c]{0.985\textwidth}{
				...
				Ist das Licht rotverstimmt ($\varDelta < 0$), so sieht ein in positive $x$-Richtung fliegendes Atom das entgegenkommende Licht zur Resonanz hin dopplerverschoben, womit die Wahrscheinlichkeit der Absorption eines Photons zunimmt.\\
