...
\makeatother
\usepackage[backend=bibtex, sorting = none, maxnames=99, minbibnames = 2, giveninits=true, doi = false, isbn = false, date = year, url = false, abbreviate = false, bibstyle = numeric-apq]{biblatex}
