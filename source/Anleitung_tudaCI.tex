...
%%%%%%%%
% setting bibliography style
\makeatletter
\def\input@path{{./apqdesign/biblatex}}
\makeatother
\usepackage[backend=bibtex, sorting = none, maxnames=99, minbibnames = 2, giveninits=true, doi = false, isbn = false, date = year, url = false, abbreviate = false, bibstyle = apq-numeric]{biblatex}
...
\vspace{7pt}
		...
		\fbox{\parbox[c]{0.985\textwidth}{
			...
			\fbox{\parbox[c]{0.985\textwidth}{
				...
				Da der Laser einen atomaren Übergang von \isotope[85]{Rb} anregen soll, liegt es nahe, mit Hilfe einer dopplerfreien Sättigungsspektroskopie einen atomaren Übergang von \isotope[85]{Rb} als Referenz zu verwenden.\\
				...
				\begin{figure}[htb!]
					...
					\caption{Durch Anlegen eines Magnetfeldes spaltet der angeregte Zustand auf. Für das rotverstimmte Kühllicht ($\omega_{\text{L}}$) ist die Resonanzgbedingung erfüllt, wenn die Atome weit genug von der Fallenmitte entfernt sind. Sie ist auf Grund der Dopplerverschiebung ($-kv$) ebenfalls auch für Atome mit hohen Geschwindigkeiten erfüllt. Die Absorption der Photonen bewirkt eine Kraft in Richtung Fallenmitte.}
					\label{fig:FA}
				\end{figure}				
				\fbox{\parbox[c]{0.985\textwidth}{
						\begin{frage}\label{f4-1}
					...
					Das im Versuch verwendete stabile Isotop ist \isotope[85]{Rb}. Aus diesem Grund soll auf dessen Termschema kurz etwas genauer eingegangen werden.\\
					...
					Um sich die Aufspaltung in die Fein- beziehungsweise Hyperfeinstruktur herzuleiten ist es zudem noch wichtig zu wissen, dass \isotope[85]{Rb} einen Kernspin von $I=\frac{5}{2}$ besitzt.\\ 
					...
					Ein solches Sättigungsspektrum kann Abbildung \ref{fig:COF} (von $F=2$ aus) für \isotope[85]{Rb} entnommen werden.\\ 									
					\begin{figure}[htb!]
						\centering
					...
					\begin{itemize}
						...
						\item Welcher Temperatur entspricht das Dopplerlimit für \isotope[85]{Rb}?
						\item Auf welchem Prinzip beruht die sogenannte Sub-Dopplerkühlung und welche Möglichkeiten eröffnet diese?
						\item Welche Übergänge von \isotope[85]{Rb} werden zur Laserstabilisierung beziehungsweise zum Kühlen der Atome verwendet und warum ist dies sinnvoll?
						\item Welche natürliche Linienbreite und Lebensdauer ist für die D2-Linie von \isotope[85]{Rb} charakteristisch?
						\item Welche Verstimmung des Laserlichts ist zum Kühlen der Atome ideal und welchen Wert muss diese für \isotope[85]{Rb} annehmen?
					\end{itemize}
