...
\begin{figure}[htb!]
	\centering
	\includegraphics[width=\textwidth]{graphics/Rack_new.jpg}
	\caption{Ausschnitt des Racks inklusiver der Stromtreiber und Lockboxen zur Frequenzstabiliserung der Laser.}
	\label{fig:Rack}
\end{figure} 
		...
		\fbox{\parbox[c]{0.985\textwidth}{
			...
			\fbox{\parbox[c]{0.985\textwidth}{
				...
				\fbox{\parbox[c]{0.985\textwidth}{
					...
					Ein solches Sättigungsspektrum kann \hyperref[fig:COF]{Abbildung \ref{fig:COF}} (von $F=2$ aus) für \isotope[85]{Rb} entnommen werden.\\ 									
					\begin{figure}[htb!]
						\centering
