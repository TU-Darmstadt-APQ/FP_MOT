...
\textbf{Hinweis:} Bringen Sie zur Versuchsdurchführung einen  \emph{USB-Stick} mit, um die während der Versuchsdurchführung gewonnenen Daten mitnehmen zu können.
...
\begin{enumerate}
	...
	\item \sloppy \textbf{Theorie MOT:} Dopplerkühlung, Energieniveaustruktur \isotope[85]{Rb}, Quadrupolfeld, Sub-Dopplerkühlung   
\end{enumerate}
...
Die Steuerung der einzelnen Phasen des Versuchsablaufs findet mittels \textit{labscript} satt. Die Ansteuerung der der einzelnen steuerbaren Elemente des Versuchs erfolgt über \textit{BLACS}, während über den \textit{runmanager} vollständige Experimentabläufe geladen werden. Die Auswertung beziehungsweise Weiterverarbeitung der Daten erfolgt mittels \textit{lyse}. Die Benutzeroberfläche ist beispielhaft in Abbildung \ref{fig:ES} dargestellt.
\begin{figure}[htb!]
	\centering
...
\vspace{7pt}
		...
		\fbox{\parbox[c]{0.985\textwidth}{
			...
			\section{Photodiode}
			In diesem Abschnitt soll kurz auf den Aufbau und das Funktionsprinzip einer Photodiode eingegangen werden, da diese sowohl zur Aufnahme des Spektroskopiesignals des Rückpump- und Kühllasers als auch zur Aufnahme des Schwebungssignals für den \nameref{ssec:Offsetlock} zur Stabilisierung des Kühllasers verwendet wird.\\
			...
			\fbox{\parbox[c]{0.985\textwidth}{
				...
				\subsection{Dopplerkühlung - Optische Melasse}				
				...
				\fbox{\parbox[c]{0.985\textwidth}{
					...
					\begin{figure}[htb!]
						\centering
						\includegraphics[width = \textwidth]{graphics/TS_korrigiert.jpg}
						\caption{Ausschnitt aus dem Termschema von $^{85}$Rb (D2-Linie) mit entsprechenden Übergangsfrequenzen}
						\label{fig:TS}
					\end{figure}
					\begin{figure}[htb!]
						\centering
						\includegraphics[width = \textwidth]{graphics/SCO.jpg}
